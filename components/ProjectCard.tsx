...
export default function ProjectCard({ 
  ...
  return (
    ...
    >
      <Card className="h-full premium-card group transition-all duration-500 overflow-hidden flex flex-col p-0 rounded-xl shadow-2xl border border-white/10 hover:border-white/20" style={{ height: '420px' }}>
        {/* Thumbnail */}
